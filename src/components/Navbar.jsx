...
const Navbar = () => {
  ...
  return (
    <React.Fragment>
      {/* Mobile Menu Toggle */}
      <button
        className="md:hidden fixed top-4 left-4 z-50 p-2 bg-green-500 text-white rounded-full shadow-lg"
      ...
      <div
        className={` h-full ${isOpen ? "w-64" : "w-0"} md:w-64 bg-green-500 text-white shadow-lg transition-all duration-300 ease-in-out overflow-hidden`}
      >
        {/* Profile Section */}
