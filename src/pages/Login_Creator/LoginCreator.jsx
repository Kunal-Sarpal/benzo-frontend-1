  ...
  return (
    <div className="flex justify-center items-center h-screen bg-green-100">
      <div className="bg-white shadow-lg border border-gray-300 rounded-lg w-11/12 max-w-md p-6 flex flex-col space-y-6">
        ...
        <button className="bg-transparent text-green-500 border border-green-500 py-2 rounded-md hover:bg-green-500 hover:text-white transition duration-300 w-full">
