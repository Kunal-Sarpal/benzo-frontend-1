...
const ShopPage2 = () => {
    return (
        <div className="w-full border-2 bg-[#FAFAFA] min-h-screen">
            {/* Header Section */}
            <header className=" text-white text-center py-4 mt-10">
                <h1 className="text-4xl font-normal text-green-500">Our Products</h1>
                <p className="mt-2 text-lg text-black">Explore Our Latest Products</p>
            </header>
